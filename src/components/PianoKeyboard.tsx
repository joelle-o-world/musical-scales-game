...
export const PianoKeyboard: FunctionComponent<{
  ...
  for(let i=0; i < numberOfKeys; ++i) {
    ...
    const keyName = keyNames[pitchClass]
    const flatKeyName = flatKeyNames[pitchClass];
    ...
    const className = classNames(
      ...
      flatKeyName,
      { 
        highlighted: highlightKeys.includes(pitch) || highlightPitchClasses.includes(pitchClass),
